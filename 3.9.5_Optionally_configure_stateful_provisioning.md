...
[root@dasandata:~]#
[root@dasandata:~]# wwvnfs --chroot /opt/ohpc/admin/images/centos7.5_local/
Using 'centos7.5_local' as the VNFS name
Creating VNFS image from centos7.5_local
...
[root@dasandata:~]#
[root@dasandata:~]# wwsh provision set c43 --vnfs=centos7.5_local --filesystem=gpt --bootloader=sda
Are you sure you want to make the following changes to 1 node(s):

     SET: VNFS                 = centos7.5_local
       SET: BOOTLOADER           = sda
